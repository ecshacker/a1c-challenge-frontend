          ...
          <Section label="What you'll need">
            <Prereq title="The food" summary="Hemp seed and raw cannabis flower, eaten raw." open={open === 0} onToggle={() => setOpen(open === 0 ? null : 0)}>
              ...
              <p style={{ fontFamily: SERIF, fontSize: 15.5, lineHeight: 1.6, color: C.inkSoft, margin: "0 0 13px" }}>
                ...
                Recommend reading the <a href="https://cannabis-is-food.com/products/cannabis-is-food-book?discount=A1C" target="_blank" rel="noopener noreferrer">Cannabis Is Food</a> book or searching online for &ldquo;hemp hearts&rdquo; if you lack local stores nearby.
              </p>
